...
def linear(n, p, noise=False, low=-1, high=1, x = None):
    r"""
    Linear simulation.
...
def exponential(n, p, noise=False, low=0, high=3, x=None):
    r"""
...
def cubic(n, p, noise=False, low=-1, high=1, cubs=[-12, 48, 128], scale=1 / 3, x=None):
    r"""
    Cubic simulation.
...
def step(n, p, noise=False, low=-1, high=1, x=None):
    r"""
    Step simulation.
...
def quadratic(n, p, noise=False, low=-1, high=1, x=None):
    r"""
...
def w_shaped(n, p, noise=False, low=-1, high=1, x=None):
    r"""
    W-Shaped simulation.
...
def logarithmic(n, p, noise=False, x=None):
    r"""
...
def fourth_root(n, p, noise=False, low=-1, high=1, x=None):
    r"""
...
def _sin(n, p, noise=False, low=-1, high=1, period=4 * np.pi, x=None):
...
def sin_four_pi(n, p, noise=False, low=-1, high=1, x = None):
    r"""
    ...
    x,y : ndarray
        ...
        dimensions.
    """
    return _sin(n, p, noise=noise, low=low, high=high, period=4 * np.pi, x=None)


def sin_sixteen_pi(n, p, noise=False, low=-1, high=1, x=None):
    r"""
    ...
    x,y : ndarray
        ...
        dimensions.
    """
    return _sin(n, p, noise=noise, low=low, high=high, period=16 * np.pi, x= None)


def _square_diamond(n, p, noise=False, low=-1, high=1, period=-np.pi / 2, x=None):
    ...
    if x is None:
        ...
        u = (x - v * np.sin(period) + 0.05 * p * gauss_noise)/np.cos(period)
...
def square(n, p, noise=False, low=-1, high=1, x=None):
    r"""
    Square simulation.
    ...
    x,y : ndarray
        ...
        dimensions.
    """
    return _square_diamond(n, p, noise=noise, low=low, high=high, period=-np.pi / 8, x=None)


def two_parabolas(n, p, noise=False, low=-1, high=1, prob=0.5, x=None):
    r"""
...
def diamond(n, p, noise=False, low=-1, high=1, x=None):
    r"""
    Diamond simulation.
    ...
    x,y : ndarray
        ...
        dimensions.
    """
    return _square_diamond(n, p, noise=noise, low=low, high=high, period=-np.pi / 4, x=None)


def multiplicative_noise(n, p, x=None):
    r"""
